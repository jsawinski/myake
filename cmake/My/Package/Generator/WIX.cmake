...
#[=======================================================================[.md:
# My/Package/Generator/WIX

**See also**:
- [CPack DEB Generator](https://cmake.org/cmake/help/latest/cpack_gen/wix.html)
#]=======================================================================]
include_guard(GLOBAL)

message(TRACE "Loaded My/Package/Generator/WIX...")

#[==[.md:
# my_generator_wix

FIXME
    my_package(WIX [COMMON]
        ...
    )

#]==]
function(my_generator_wix)
    message(TRACE "my_generator_wix(${_MY_PACK_COMMON},${__MY_PACK_ARGS})")
...
#        
#        You may for example explicitly set this variable in your CMakeLists.txt
#        to the value that has been generated per default. You should not use 
#        GUIDs that you did not generate yourself or which may belong to other 
#        projects.
#        
...
#        converted to RTF by the WIX Generator. The expected encoding of the 
#        .txt file is UTF-8.
#        
...
#        languages at: https://wixtoolset.org/docs/v3/wixui/wixui_localization/
#        
# [ ] CPACK_WIX_TEMPLATE
#        
...
#        generate the WiX wxs file. This should be used if further customization
...
#            attribute Id { string },    fragmentContent*}
...
#        `<TOOL>`.
#        
#        Use it at your own risk. Future versions of CPack may generate flags 
#        which may be in conflict with your own flags.
#        
...
#        `HKEY_LOCAL_MACHINE\Software\Kitware\CMake\Packages<PackageName>` The 
...
#        [CPACK_COMPONENT]()]<compName>_DISPLAY_NAME for components.
#        
# [ ] CPACK_WIX_ROOT_FEATURE_DESCRIPTION
#        
#        Sets the description of the root install feature in the WIX installer. 
#        Same as [CPACK_COMPONENT]()]<compName>_DESCRIPTION for components.
#        
...
#                path that does not follow the localization or convention of the
#                system on which the installation is performed.
#        
...
#        32-bit and 64-bit variants. In 32-bit builds the token will expand 
#        empty while in 64-bit builds it will expand to `64`.
#        
...
# [ ] CPACK_WIX_ROOT
#        
#        This variable can optionally be set to the root directory of a custom 
...
#        necessary for using WiX extensions. Each declaration should be in the 
#        form name=url, where name is the plain namespace without the usual 
#        xmlns: prefix and url is an unquoted namespace url. A list of commonly 
#        known WiX schemata can be found here: 
...
#        skipped, i.e. the `-ext "WixUIExtension"` command line is not included 
#        during the execution of the WiX light tool.
#        
