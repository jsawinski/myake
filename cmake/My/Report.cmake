...
displayed during a `cmake` run. See [``my_report``](Report.md#markdown-header-my_report)
for further details.
...
Note here, as can be seen in the last line, that limited output formatting
is also supported.
...
Create a report topic. The option ``FILE`` sets the output file for the report, by default this is
${CMAKE_BINARY_DIR}/Report<topic>.txt.
...
This command is called from [``my_report``](Report.md#markdown-header-my_report).
